...
#Used K+1 as range function is not inclusive at end
...
#C is an array of 0 of length k+1. After being run, it shows the number of occurences of each key value.
